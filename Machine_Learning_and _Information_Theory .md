...
> In information theory, the entropy can be interpreted as the expected number of bits required to represent and transmit an outcome of a random variable x when using the most efficient binary code based on $P_x$ .